        ...
        v = function (e, t) {
          ...
          var D = !1,
            ...
            q = function (e) {
              var s = B(e);
              typeof s == "string"
                ? (s && t.onPaste(s, e), i.isIE && setTimeout(A), r.preventDefault(e))
                : ((n.value = ""), (m = !0));
            };
          ...
          var R = function (e) {
            ...
            U = function () {
              ...
              if (g.useTextareaForIME) t.onCompositionUpdate(n.value);
                ...
                P(e),
                  g.markerRange &&
                    (g.context && (g.markerRange.start.column = g.selectionStart = g.context.compositionStartOffset),
      ...
      (function () {
        (this.CHANGE_CURSOR = 1),
          ...
          (this.showComposition = function (e) {
            (this.$composition = e),
              e.cssText ||
                ((e.cssText = this.textarea.style.cssText), (e.keepTextAreaAtCursor = this.$keepTextAreaAtCursor)),
