        ...
        (this.setFilter = function (e) {
          ...
          (this.filterText = e),
            ...
            (t = t.sort(function (e, t) {
              return (
                t.exactMatch - e.exactMatch || t.$score - e.$score || (e.caption || e.value) < (t.caption || t.value)
              );
            }));
          var n = null;
      ...
      var r = e("../snippets").snippetManager,
        ...
        l = {
          getCompletions: function (e, t, n, i, s) {
            ...
            u && u.type.match(/(tag-name|tag-open|tag-whitespace|attribute-name|attribute-value)\.xml$/)
              ? o.push("html-tag")
