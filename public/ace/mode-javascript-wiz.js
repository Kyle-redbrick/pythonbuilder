  ...
  function (require, exports, module) {
    ...
    (function () {
      ...
      this.createWorker = function (session) {
        var worker = new WorkerClient(["ace"], "ace/mode/javascript-wiz_worker", "JavaScriptWorker");
        worker.attachToDocument(session.getDocument());
        worker.send("lang", window.localStorage.getItem("wizLang"));
      ...
      this.$id = "ace/mode/javascript-wiz";
    }).call(Mode.prototype);
...
(function () {
  ace.require(["ace/mode/javascript-wiz"], function (m) {
